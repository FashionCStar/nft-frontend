...
function PrivacyPolicy() {
    ...
    <p>
        Your privacy is important to us. It is Society of Galactic Exploration's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://starseas.space, and other sites we own and operate.
    </p>
    <p>
        <br />
    ...
    <p>
        <br />
        This policy is effective as of 10 December 2021.
    </p>
    <p>
        <br />
    ...
    <p>
        We may ask for personal information &mdash; for example, when you submit content to us or when you contact us &mdash; which may include one or more of the following:
    </p>
    <p>
        <br />
        Name
    ...
    <p>
        <br />
        Information from third parties: If we receive personal information about you from a third party, we will protect it as set out in this privacy policy. If you are a third party providing personal information about somebody else, you represent and warrant that you have such person&rsquo;s consent to provide the personal information to us.
    </p>
    <p>
        <br />
    ...
    <p>
        At all times, you may decline cookies from our site if your browser permits. Most browsers allow you to activate settings on your browser to refuse the setting of all or some cookies. Accordingly, your ability to limit cookies is based only on your browser&rsquo;s capabilities. Please refer to the Cookies section of this privacy policy for more information.
    </p>
    <h3>
        <br />
